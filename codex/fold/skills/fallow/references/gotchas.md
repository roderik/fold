...
Fallow works with zero configuration for most projects thanks to 85 auto-detecting framework plugins. Creating an unnecessary config file can mask issues or override detection behavior.
